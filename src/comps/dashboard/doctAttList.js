...
export default function DAttenList() {
    ...
    const filteredList = list.filter(item => item.id.startsWith('DR'));
    ...
    const exportExcel = () => {
        import('xlsx').then((xlsx) => {
            ...
            saveAsExcelFile(excelBuffer, 'Doctor Attendance');
        });
    };
    ...
    const initFilters = () => {
        setFilters({
            ...
            id: { value: 'DR', matchMode: 'startsWith' }, // Set the initial value for 'id' filter
