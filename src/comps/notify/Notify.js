...
function Notify(props) {
    ...
    let [lst, setLst] = useState([]); // Initialize as an empty array
    ...
    }, [fdo, fdu, hru, hro, fda, dra, dro, dru]);
    ...
    const [filterText, setFilterText] = useState(""); // State for input box value
    const [showChecked, setShowChecked] = useState(false); // State for checkbox selection
        ...
        <div>
            ...
            <div style={{ position: "relative" }}>
                ...
                <div style={{ height: "600px", backgroundColor: "rgba(255,255,255,0.3)", width: "1300px", borderRadius: "20px", textAlign: "center", marginLeft: "110px", marginTop: "80px" }}>
                    ...
                    {
                        user.job.name == "Front Desk Officer" && (
                            <div>
...

                    {
                        user.job.name == "HR" && (
                            <div>
                                <button autoFocus id="fhd" onClick={() => hrufunc()}>You</button>
