...
function AppCont() {
    ...
    return (
        <div style={{ height: "750px" }}>
            ...
            <img src={doc} alt="none" width="100%" height="746px" />

            <div style={{ position: "relative", zIndex: "10", backgroundColor: "rgba(20, 167, 142, 0.453)", width: "100%", height: "805px", top: "-805px" }}></div>



            <div style={{ fontSize: "15px", backgroundColor: "white", position: "absolute", top: "25px", left: "380px", width: "775px", height: "700px", padding: "70px", marginBottom: "0px", position: "absolute", zIndex: "30" }}>
                ...
                <div style={{ display: "flex" }}>
                    <label style={{ width: "100px" }} htmlFor="name" className="font-bold block mb-2">Your Name</label><br />
                    <InputText style={{ width: "300px", height: "30px", padding: "20px", marginTop: "30px", marginBottom: "20px", marginLeft: "-100px" }} value={name} onChange={(e) => setName(e.target.value)} placeholder="John Doe" />
                    <label style={{ marginLeft: "30px", marginTop: "2px" }} htmlFor="email" className="font-bold block mb-2">Date of Birth</label>
                    <Calendar style={{ width: "278px", height: "40px", marginTop: "31px", marginLeft: "-83px" }} value={birth} onChange={(e) => setBirth(e.value)} maxDate={maxDate}/>
                </div>

                <div className="appFont" style={{ display: "flex", marginBottom: "10px" }}>
                    <label htmlFor="phone" className="font-bold block mb-2">Phone</label>
                    <InputMask style={{ width: "300px", height: "30px", padding: "20px", marginTop: "30px", marginBottom: "20px", marginLeft: "-42px" }} id="phone" value={ph} onChange={(e) => setPh(e.target.value)} mask="(999) 999-9999" placeholder="(999) 999-9999"></InputMask>

                    <label style={{ marginLeft: "30px", marginTop: "5px" }} htmlFor="email" className="font-bold block mb-2">Email</label>
                    <InputText style={{ width: "300px", height: "30px", padding: "20px", marginTop: "30px", marginBottom: "20px", marginLeft: "-36px" }} type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="johndoe@gmail.com" />
                </div>

                <div className="appFont" style={{ display: "flex", marginTop: "-10px" }}>
                    <div>
                        <label style={{ width: "90px" }} htmlFor="cause" className="font-bold block mb-2">Cause of Visit</label>
                    ...
                    <div className="popup-container">
                        ...
                        <div className="popup-background">
                            <div className="popup-content">
                                ...
                                <Calendar style={{ height: "40px" }} value={date} onChange={(e) => setDate(e.value)} showIcon iconclassname="calendar-icon" icon={(props) => (
                                    <i
                                        {...props}
